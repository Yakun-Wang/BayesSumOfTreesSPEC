...
% Spectral Analysis of Multiple Time Series" by Yakun, Zeda, and Bruce (2021)
%
% Author: Yakun Wang
% 
% Date: April 22, 2021
...
% Analysis of Multiple Time Series" by Yakun, Zeda, and Bruce (2021)
%
% Dependencies:
% Code was developed using R versio 4.0.3
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
<programs> Folder containing three R packges needed to run the Bayesian 
        ...
        process described in the paper, and a R script to generate the
...
<Gait_Maturation> Folder containing the raw data, the R script to generate 
        ...
        produce the ALE plots described in the paper is included in the folder.
...
<ALE.R>: R file to generate ALE plots of age and speed for gait maturation 
